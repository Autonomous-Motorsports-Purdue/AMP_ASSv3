...
#
# Modified by Autonomous Motorsports Purdue
...
def generate_launch_description():
    ...
    sim_dir = get_package_share_directory('amp_kart_simulate')
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(bringup_dir, 'params', 'nav2.params.yaml'),
        description=
    ...
    declare_bt_xml_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            get_package_share_directory('amp_kart_bt_navigator'),
